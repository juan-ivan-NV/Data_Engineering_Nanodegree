...
class LoadDimensionOperator(BaseOperator):
    ...
    insert_into_stmt = """INSERT INTO {table} {select_query}"""
    ...
    def execute(self, context):
        ...
        if self.truncate_table:
            self.log.info("Table will be truncated before inserting data ")
            redshift.run(LoadDimensionOperator.truncate_stmt.format(
                table = self.table
            ))
            
        self.log.info("Inserting data to dimesion tables ")
