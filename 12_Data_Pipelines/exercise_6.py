# Instructions
"""
1.- Create a Airflow conection called aws_credentials with your AWS 
    {Access key ID} & {Secret access key}
2.- Create a redshift cluster in the same region as the udacity S3 instance
3.- Create an Airflow conection with your Redshift cluster credentials 
"""
