...
# Init the Airflow UI /opt/airflow/start.sh
...
#
# DONE: Replace the data quality checks with the HasRowsOperator
#
...
#
# DONE: Replace this data quality check with the HasRowsOperator
#
