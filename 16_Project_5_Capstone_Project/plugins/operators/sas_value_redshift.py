...
class SASValueToRedshiftOperator(BaseOperator):
    ...
    def __init__(self,
        ...
        self.aws_credentials_id = aws_credentials_id                     # Airflow connection ID for AWS key and secret.
        self.redshift_conn_id = redshift_conn_id                         # Airflow connection ID for redshift database.
        self.table = table                                               # Name of table to load data to.
        self.s3_bucket = s3_bucket                                       # S3 Bucket Name Where SAS source code is store.
        self.s3_key = s3_key                                             # S3 Key Name for SAS source code.
        self.sas_value = sas_value                                       # value to search for in sas file for extraction of data.
        self.columns = columns                                           # resulting data column names.
